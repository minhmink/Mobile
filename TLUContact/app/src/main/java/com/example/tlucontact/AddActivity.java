...
public class AddActivity extends AppCompatActivity {
    ...
    private void saveData() {
        ...
        if ("unit".equals(type)) {
            databaseHelper.addUnit(new Unit(0,name, phone, R.drawable.img_3, address));
        } else {
            databaseHelper.addEmployee(new Employee(0,name, phone, R.drawable.img_3, email, unit, position));
        }
